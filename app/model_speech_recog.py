...
def respond(voice_data):
    ...
    elif 'front light white' in voice_data:
    ...
    elif 'living room white' in voice_data:
    ...
    elif 'bedroom white' in voice_data:
    ...
    elif 'kitchen white' in voice_data:
    ...
    elif 'toilet light white' in voice_data:
    ...
    elif 'backyard white' in voice_data:
